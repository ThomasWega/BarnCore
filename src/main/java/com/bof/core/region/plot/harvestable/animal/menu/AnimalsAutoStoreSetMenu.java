...
public class AnimalsAutoStoreSetMenu extends ChestGui {
    ...
    public AnimalsAutoStoreSetMenu(@NotNull BarnRegion region, @Nullable AnimalPlot previousSelectedPlot) {
    ...
    private void initialize() {
        ...
        this.addPane(new GoBackPane(4, 3, new AnimalsAutoStoreMenu(this.region)));
                        ...
                        .forEach(plot -> {
                            ...
                            this.mainPane.addItem(new GuiItem(
                                    ...
                                    event -> {
                                        ...
                                        new AnimalsAutoStoreMenu(region).show(event.getWhoClicked());
                                    }
                            ));
                        }));
    }
